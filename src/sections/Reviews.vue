  ...
  <section class="partners">
    <div class="container">
      ...
      <swiper :modules="modules" :navigation="{
        nextEl: '.btn-next',
        prevEl: '.btn-prev',
      }" :loop="true" class="mySwiper" :slidesPerView="2" :space-between="30" 
      :breakpoints="{
        ...
        <swiper-slide>
          <div class="card h-[300px] m-1 md:m-4 pt-4 xl:pt-0 xl:py-10 px-6 rounded-sm shadow-lg shadow-[rgba(56, 56, 56, 0.05)]">
            <div class="user flex items-start justify-between flex-wrap">
            ...
            <p class="desc max-w-[600px] pt-3 md:pt-5 font-semibold text-base text-[#8D8D8D] overflow-scroll md:overflow-auto h-40 md:h-full">Чтобы избежать лишних финансовых
              затрат,
        ...
        <swiper-slide>
          <div class="card h-[300px] md:m-4 pt-4 xl:pt-0 xl:py-10 px-6 rounded-sm shadow-lg shadow-[rgba(56, 56, 56, 0.05)]">
            <div class="user flex items-start justify-between flex-wrap">
              <div class="flex items-center gap-5">
                <img src="../assets/images/user_1.png" alt="" class="w-[85px] h-[85px] rounded-full ">
                <div class="contacts">
